    ...
    public void CalculateAllPossibleMoves(ChessBoard board,ArrayList <Points> AvailableDes) {
        ...
        if (this.color == PieceColor.Black) {
            ...
            if (this.yPos + 1 < 8 && this.yPos + 2 < 8 && this.canMoveTwice && !board.Squares[this.yPos + 1][this.xPos].ContainPiece && !board.Squares[this.yPos + 2][this.xPos].ContainPiece) {
                AvailableDes.add(new Points(yPos + 2, xPos));
                AvailableDes.add(new Points(yPos + 1, xPos));
            } //normal move (1 move)
                ...
                AvailableDes.add(new Points(yPos + 1, xPos + 1));
            ...
            if (this.yPos - 1 >= 0 && this.yPos - 2 >= 0 && this.canMoveTwice && !board.Squares[this.yPos - 1][this.xPos].ContainPiece && !board.Squares[this.yPos - 2][this.xPos].ContainPiece) {
                AvailableDes.add(new Points(yPos - 2, xPos));
                AvailableDes.add(new Points(yPos - 1, xPos));
            } //normal move (1 move)
